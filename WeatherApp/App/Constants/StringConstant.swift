...
enum StringConstant {
    ...
    enum MockCity {
        ...
        static let londonTimezone = "Europe/London"
        static let paris = "Paris"
        static let parisCountry = "FR"
        static let ileDeFrance = "Île-de-France"
        static let parisTimezone = "Europe/Paris"
        static let newYork = "New York"
        static let unitedStatesCountry = "US"
        static let newYorkTimezone = "America/New_York"
        static let tokyo = "Tokyo"
        static let tokyoCountry = "JP"
        static let tokyoTimezone = "Asia/Tokyo"
        static let mumbai = "Mumbai"
        static let mumbaiCountry = "IN"
        static let maharashtra = "Maharashtra"
        static let mumbaiTimezone = "Asia/Kolkata"
        static let sydney = "Sydney"
        static let sydneyCountry = "AU"
        static let newSouthWales = "New South Wales"
        static let sydneyTimezone = "Australia/Sydney"
        static let berlin = "Berlin"
        static let berlinCountry = "DE"
        static let berlinTimezone = "Europe/Berlin"
        static let losAngeles = "Los Angeles"
        static let losAngelesRegion = "California"
        static let losAngelesTimezone = "America/Los_Angeles"
    }
}
